...
urlpatterns = [
    ...
    path('ajax/add-item/', views.AddItemView.as_view(), name='add_item'),
    path('ajax/remove-item/', views.RemoveItemView.as_view(), name='remove_item'),
    ...
    path('e/<slug:event_slug>', views.IndexView.as_view(), name='event'),
]
